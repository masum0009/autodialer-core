...
typedef void (sipsess_reg_h)(struct sipsess_sock *sock, const struct sip_msg *msg);
...
int sipsess_init(struct sipsess **sessp, struct sipsess_sock *sock,
		   const struct sip_msg *msg, const char *cuser, const char *ctype,
		   sip_auth_h *authh, void *aarg, bool aref,
		   sipsess_offer_h *offerh, sipsess_answer_h *answerh,
		   sipsess_estab_h *estabh, sipsess_info_h *infoh,
		   sipsess_refer_h *referh, sipsess_close_h *closeh,
...
void add_register_handler(struct sipsess_sock *sock,sipsess_reg_h *regh);
